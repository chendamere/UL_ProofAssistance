...
export const rule = (getChecks, onMatch) => reader => {
...
export const exactly = (...checks) => reader => {
...
export const either = (...checks) => reader => {
    // console.log("either")
...
export const optional = (check, defaultValue = { type: 'optional' }) => reader => {
...
export const token = (type, value = null) => reader => {
    ...
    // console.log(type, value, reader.get())
